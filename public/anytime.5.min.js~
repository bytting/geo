...
if(window.location.hostname.length&&(window.location.hostname!='dev.ama3.com')&&(window.location.hostname!='www.ama3.com')&&(!/best.*picker.com$/.test(window.location.hostname)))alert('REMOVE THE LAST LINE FROM anytime.5.0.1-1403131246.min.js!');
